...
namespace MrMedBot.Dialogs
{
    public class BookingDialog : CancelAndHelpDialog
    {
        /*private const string DestinationStepMsgText = "How may I help you?";
        private const string OriginStepMsgText = "Can we get Ambulance dail number?";*/
